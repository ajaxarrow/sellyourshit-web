...
Got a five-hundred-item closet and zero memory of what you named that
one hoodie? That's what this page is for.
...
[Selling Items](./04-selling-items.md) for that whole flow. Filter
first, then select, so you're not hunting through 200 cards for the 5
you actually sold.
